###########################################################################
GENERATED IMPLEMENTATION ARTIFACT SKELETON FOR org_opentosca_nodetypes_VMWare5_5__CloudProviderInterface

Interface Name: org_opentosca_nodetypes_VMWare5_5__CloudProviderInterface
Namespace: http://implementationartifacts.opentosca.org/
Java Package: org.opentosca.implementationartifacts
URL: http://192.168.209.220:8080/winery/artifacttemplates/http%253A%252F%252Fopentosca.org%252Fartifacttemplates/VMWare5.5_ArtifactTemplate_CloudProviderInterface/files/../
###########################################################################
...
+ Install the vijava into your local maven repository by executing the following command inside the libs folder:
	mvn install:install-file -Dfile=vijava55b20130927.jar -DgroupId=own -DartifactId=vijava -Dversion=5.5 -Dpackaging=jar
